...
END;
		...
		echo <<<END
			<div id="copyright">
				<a href="http://mybb.com/" target="_blank">MyBB</a> &copy; 2002-$copyyear <a href="http://mybb.com/" target="_blank">MyBB Group</a>, Tłumaczenie: © 2007-$copyyear <a href="http://www.mybboard.pl">Polski Support MyBB</a>
			</div>
		</div>
		</div>
		</div>
